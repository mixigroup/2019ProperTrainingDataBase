...
/** @file ha_kiyoshi.h
    ...
    @brief
  The ha_kiyoshi engine is a stubbed storage engine for example purposes only;
  it does nothing at this point. Its purpose is to provide a source
  code illustration of how to begin writing new storage engines; see also
  /storage/example/ha_kiyoshi.cc.

    @note
  Please read ha_kiyoshi.cc before reading this file.
  ...
  *required* to be implemented. For a full list of all methods that you can
  implement, see handler.h.
   ...
   @see
  /sql/handler.h and /storage/example/ha_kiyoshi.cc
*/
...
*/
class ha_kiyoshi : public handler {
 ...
 public:
  ha_kiyoshi(handlerton *hton, TABLE_SHARE *table_arg);
  ~ha_kiyoshi() {}
  ...
  */
  ...
  /*
    Everything below are methods that we implement in ha_kiyoshi.cc.

    Most of these methods are not obligatory, skip them and
    MySQL will treat them as not implemented
  */
  /** @brief
    We implement this in ha_kiyoshi.cc; it's a required method.
  */
  ...
  */
  ...
  /** @brief
    We implement this in ha_kiyoshi.cc. It's not an obligatory method;
